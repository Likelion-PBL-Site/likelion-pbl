 ...
 * 각 트랙의 브랜드 컬러 기반
 */
export const trackStageColors: Record<TrackType, string> = {
  react: "bg-sky-500/15 text-sky-600 dark:text-sky-400 border-sky-500/30",
  springboot: "bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border-emerald-500/30",
  django: "bg-green-500/15 text-green-600 dark:text-green-400 border-green-500/30",
  design: "bg-violet-500/15 text-violet-600 dark:text-violet-400 border-violet-500/30",
};
...
export const tracks: TrackInfo[] = [
  ...
  },
  {
    ...
    name: "백엔드 (Django)",
    description:
      "Python과 Django를 활용한 서버 개발을 학습합니다. MTV 패턴, CRUD, ORM 등 백엔드 전반을 다룹니다.",
    icon: "Server",
